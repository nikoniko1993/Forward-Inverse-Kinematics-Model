...
public class Camera {
	...
	public static void acceptInputMove(float delta) {
		...
		//Restricting movement of camera
//		pos.x = Math.max(-12f, Math.min(12f, pos.x));
//		pos.y = Math.max(-12f, Math.min(12f, pos.y));
//		pos.z = Math.max(-12f, Math.min(12f,  pos.z));
	}
